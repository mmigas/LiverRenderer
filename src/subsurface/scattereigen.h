...
NAMESPACE_BEGIN(mitsuba)
    ...
    public:
        ...
        static inline constexpr int nPolyCoeffs(int polyOrder) {
            return nChooseK(3 + polyOrder, polyOrder);
        }

        static inline constexpr int nInFeatures(int polyOrder) {
            return nPolyCoeffs(polyOrder) + 3;
        }
        ...
        preprocessFeatures(const Spectrum& albedo,
                           float g,
                           float ior,
            ...
            if (useSimilarityTheory) {
                ...
                effectiveAlbedo = Volpath3D<Float, Spectrum>::effectiveAlbedo(albedoP).average();
            } else {
                effectiveAlbedo = Volpath3D<Float, Spectrum>::effectiveAlbedo(albedo).average();
            }
    ...
    template<size_t PolyOrder /*= 3*/, size_t LayerWidth /*= 64*/, typename Float, typename Spectrum>
    ...
    public:
        ...
        AbsorptionModel(const std::string& variablePath, const json& stats, const std::string& shapeFeaturesName) {
            absorption_mlp_fcn_0_biases =
                    NetworkHelpers<Float, Spectrum>::loadVectorDynamic(
                        variablePath + "/absorption_mlp_fcn_0_biases.bin");
            absorption_mlp_fcn_1_biases =
                    NetworkHelpers<Float, Spectrum>::loadVectorDynamic(
                        variablePath + "/absorption_mlp_fcn_1_biases.bin");
            absorption_mlp_fcn_2_biases =
                    NetworkHelpers<Float, Spectrum>::loadVectorDynamic(
                        variablePath + "/absorption_mlp_fcn_2_biases.bin");
            absorption_dense_bias = NetworkHelpers<Float, Spectrum>::loadVectorDynamic(
                variablePath + "/absorption_dense_bias.bin");
            absorption_mlp_fcn_0_weights =
                    NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                        variablePath + "/absorption_mlp_fcn_0_weights.bin");
            absorption_mlp_fcn_1_weights =
                    NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                        variablePath + "/absorption_mlp_fcn_1_weights.bin");
            absorption_mlp_fcn_2_weights =
                    NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                        variablePath + "/absorption_mlp_fcn_2_weights.bin");
            absorption_dense_kernel = NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                variablePath + "/absorption_dense_kernel.bin");
        ...
        float run(Spectrum albedo, float g, float ior, const Spectrum& sigmaT, const ShapeVector& polyCoeffs) const {
            Eigen::Matrix<float, NetworkHelpers<Float, Spectrum>::nInFeatures(PolyOrder), 1> input =
                    NetworkHelpers<Float, Spectrum>::preprocessFeatures < PolyOrder > (
                        albedo, g, ior, sigmaT, polyCoeffs, m_albedoMean, m_albedoStdInv,
        ...
        Eigen::Matrix<float, LayerWidth, NetworkHelpers<Float, Spectrum>::nInFeatures(PolyOrder)>
        absorption_mlp_fcn_0_weights;
    ...
    template<typename Float, typename Spectrum, typename Sampler>
    ...
    public:
        ...
        run(const Eigen::Vector3f& inPos, const Eigen::Vector3f& inDir, const Spectrum& albedo, float g, float ior,
            ...
            const Eigen::Matrix<Float, NetworkHelpers<Float, Spectrum>::nPolyCoeffs(3), 1>& polyCoeffs,
            Sampler* sampler,
            /*const Matrix3x3& toAsTransform*/ const drjit::Matrix<Float, 3> toAsTransform) const = 0;
    ...
    /*template<size_t PolyOrder = 3, size_t NLatent = 8, size_t LayerWidth = 64,
        size_t PreLayerWidth = 32, typename Float, typename Spectrum, typename Sampler>
    class ScatterModel : public ScatterModelBase<Float, Spectrum, Sampler> {
    public:
        ScatterModel() {
        }

        // ScatterModel(const std::string &variablePath, const VaeConfig &config) {
        ScatterModel(const std::string& variablePath, const std::string& absVariablePath, const json& stats,
                     const std::string& shapeFeaturesName,
                     const std::string& predictionSpace = "LS") {
            absModel = AbsorptionModel<3, 64, Float, Spectrum>(absVariablePath, stats, shapeFeaturesName);
            ...
            scatter_shapemlp_fcn_0_biases =
                    NetworkHelpers<Float, Spectrum>::loadVectorDynamic(
                        variablePath + "/scatter_shapemlp_fcn_0_biases.bin");
            scatter_shapemlp_fcn_1_biases =
                    NetworkHelpers<Float, Spectrum>::loadVectorDynamic(
                        variablePath + "/scatter_shapemlp_fcn_1_biases.bin");
            scatter_shapemlp_fcn_2_biases =
                    NetworkHelpers<Float, Spectrum>::loadVectorDynamic(
                        variablePath + "/scatter_shapemlp_fcn_2_biases.bin");
            scatter_dense_2_bias = NetworkHelpers<Float, Spectrum>::loadVectorDynamic(
                variablePath + "/scatter_dense_2_bias.bin");
            ...
            scatter_shapemlp_fcn_0_weights =
                    NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                        variablePath + "/scatter_shapemlp_fcn_0_weights.bin");
            scatter_shapemlp_fcn_1_weights =
                    NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                        variablePath + "/scatter_shapemlp_fcn_1_weights.bin");
            scatter_shapemlp_fcn_2_weights =
                    NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                        variablePath + "/scatter_shapemlp_fcn_2_weights.bin");
            scatter_dense_2_kernel = NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                variablePath + "/scatter_dense_2_kernel.bin");
        ...
        /*std::pair<Eigen::Vector3f, float> run(const Eigen::Vector3f& inPos, const Eigen::Vector3f& inDir,
                                              ...
                                              const Eigen::Matrix<float, NetworkHelpers<Float, Spectrum>::nPolyCoeffs(
                                                  PolyOrder), 1>&
                                              polyCoeffs,
                                              Sampler* sampler, const Matrix3x3& toAsTransform) const override {
            Eigen::Matrix<float, NetworkHelpers<Float, Spectrum>::nInFeatures(PolyOrder), 1> x =
                            NetworkHelpers<Float, Spectrum>::preprocessFeatures < PolyOrder,false > (
                albedo, g, ior, sigmaT, polyCoeffs, m_albedoMean, m_albedoStdInv,
                m_gMean, m_gStdInv, m_shapeFeatMean, m_shapeFeatStdInv);
        ...
        Eigen::Matrix<float, PreLayerWidth, NetworkHelpers<Float, Spectrum>::nInFeatures(PolyOrder)>
        scatter_shapemlp_fcn_0_weights;
        ...
        Eigen::Matrix<float, NetworkHelpers<Float, Spectrum>::nPolyCoeffs(PolyOrder), 1> m_shapeFeatMean,
                m_shapeFeatStdInv;
    ...
    public:
        ...
        ScatterModelEfficient(const std::string& variablePath, const std::string& absVariablePath, const json& stats,
                              const std::string& shapeFeaturesName,
                              const std::string& predictionSpace = "LS") {
    ...
    template<size_t PolyOrder /*= 3*/, size_t NLatent /*= 4*/, size_t LayerWidth /*= 64*/, size_t PreLayerWidth /*= 64*/
        ,
        typename Float, typename Spectrum, typename Sampler>
    class ScatterModelSimShared : public ScatterModelBase<Float, Spectrum, Sampler> {
    public:
        ScatterModelSimShared() {
        }

        ScatterModelSimShared(const std::string& variablePath, const std::string& absVariablePath, const json& stats,
                              const std::string& shapeFeaturesName,
                              const std::string& predictionSpace = "LS", bool useEpsilonSpace = false) {
            m_useEpsilonSpace = useEpsilonSpace;
            absorption_dense_bias =
                    NetworkHelpers<Float, Spectrum>::loadVectorDynamic(variablePath + "/absorption_dense_bias.bin");
            absorption_mlp_fcn_0_biases =
                    NetworkHelpers<Float, Spectrum>::loadVectorDynamic(
                        variablePath + "/absorption_mlp_fcn_0_biases.bin");
            scatter_decoder_fcn_fcn_0_biases =
            ...
            absorption_dense_kernel = NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                variablePath + "/absorption_dense_kernel.bin");
            absorption_mlp_fcn_0_weights = NetworkHelpers<Float, Spectrum>::loadMatrixDynamic(
                variablePath + "/absorption_mlp_fcn_0_weights.bin");
        ...
        std::pair<Eigen::Vector3f, float> run(const Eigen::Vector3f& inPos, const Eigen::Vector3f& inDir,
                                              ...
                                              const Eigen::Matrix<Float, NetworkHelpers<Float, Spectrum>::nPolyCoeffs(
                                                  PolyOrder), 1>&
                                              polyCoeffs,
                                              Sampler* sampler, /*const Matrix3x3& toAsTransform*/ dr::Matrix<Float, 3>)
        const override {
            Spectrum sigmaTp = Volpath3D<Float, Spectrum>::getSigmaTp(albedo, g, sigmaT);
            auto x = NetworkHelpers<Float, Spectrum>::preprocessFeatures/*<PolyOrder, true>*/(albedo, g, ior,
                sigmaT, polyCoeffs,
                m_albedoMean, m_albedoStdInv,
