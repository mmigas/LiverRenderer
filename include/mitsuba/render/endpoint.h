...
NAMESPACE_BEGIN(mitsuba)
    ...
    public:
         ...
         */
        virtual std::pair<Spectrum, DirectSamplingRecord<Float, Spectrum>> sampleDirect(
         ...
         */
        bool needs_sample_2() const {
            return m_needs_sample_2;
        }
         ...
         */
        bool needs_sample_3() const {
            return m_needs_sample_3;
        }
