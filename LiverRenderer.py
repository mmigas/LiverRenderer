...
def edit_scene(scene_path, model, width, height, spp, max_depth, glisson_params, parenchyma_params):
    ...
    lipid_water_spectrum = module.calc_abs_coeff(start_wavelength, end_wavelength, step, "water_lipid")
    hepaticity_spectrum = module.calc_abs_coeff(start_wavelength, end_wavelength, step, "hepatocity")
